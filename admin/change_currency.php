...
<!DOCTYPE html>
<html lang="zxx">
<!-- Mirrored from code-theme.com/html/findhouses/change-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Jul 2021 19:47:57 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <title>Elite Expert - Change Password</title>
    <!-- FAVICON -->
                    ...
                    <div class="col-lg-7 col-md-6 col-xs-6 pl-3 offset-lg-1 offset-md-3">
                       <div class="col-lg-12 mobile-dashbord dashbord">
                        ...
                        <div class="my-address">
                            <h3 class="heading pt-0">Change to Preferred Currency</h3>
                            <form method="post" action="../script/changecurrency.php">
                                <div class="row">
                                    <div class="col-lg-12 ">
                                        <div class="form-group name">
                                            <label>Enter Currency Symbol</label>
                                            <input type="text" name="currency" class="form-control" placeholder="Enter Preferred Currency Symbol" required>
                                        </div>
                                    </div>
                                    
                                    <div class="col-lg-12">
                                        <div class="send-btn mt-2">
                                            <button type="submit" name="change_c" class="btn btn-common">Send Changes</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
