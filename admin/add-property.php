...
<head>
    ...
    <title>Elite Expert - Add Properties</title>
    <!-- FAVICON -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-12 col-xs-12 royal-add-property-area section_100 pl-0 user-dash2">
                       <div class="col-lg-12 mobile-dashbord dashbord">
                        ...
                        <form action="../script/add_product.php" method="post" enctype="multipart/form-data">
                        <div class="single-add-property">
                            <h3>property Media <span style="color:red">(All image must be added in order to save images)</span></h3>
                            <div class="property-form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="property_image">Property Image</label>
                                        <input type="file" name="image1"  id="property_image" placeholder="Add your property image">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="property-form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="file" name="image2" id="image1" placeholder="Add your property image">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="image">Add image (two)</label>
                                        <input type="file" name="image3" id="image2" placeholder="Add your property image">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <p>
                                                ...
                                                <textarea id="description" name="descrip" placeholder="Describe about your property"></textarea>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6 col-sm-12">
                                            ...
                                            <select name="property_type" class="form-control-range" placeholder="Please select a property type">
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-12">
                                            ...
                                            <select name="property_status" class="form-control-range" placeholder="Please select a property status">
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-12">
                                            ...
                                            <select name="property_bedrooms" class="form-control-range" placeholder="Please select bedroom number">
                                                <option value="">Select An Option</option>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-12">
                                            ...
                                            <select name="property_bathroom" class="form-control-range" placeholder="Please select bathroom number">
                                                <option value="">Select An Option</option>
                                                <option value="1">1</option>
                                                <option value="2">2</option>
                                                <option value="3">3</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <p class="no-mb last">
                                                ...
                                                <input type="number" name="size" placeholder="Sqft" id="area">
                                            </p>
                                        </div>
                                    </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="prperty-submit-button">
                                            <button type="submit" name="add_prod">Submit Property</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
