                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-12 col-xs-12 royal-add-property-area section_100 pl-0 user-dash2">
                       <div class="col-lg-12 mobile-dashbord dashbord">
                        ...
                        <form action="../script/invoicescript.php" id="property-form" method="post">
                        ...
                        <div class="single-add-property">
                            ...
                            <div class="property-form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <p class="no-mb">
                                                <label for="Property Amount">Property Amount <span style="color:red">*</span></label>
                                                <input type="number" name="amount"  placeholder="Enter Property Amount" required>
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                         <div class="col-lg-6 col-md-12">
                                            <p class="no-mb last">
                                                <label for="vat">VAT Percentage (%) <span style="color:red">*</span></label>
                                                <input type="number" name="vat"  placeholder="Enter VAT Percentage i.e 20" required>
                                            </p>
                                        </div>
                                        <div class="col-lg-6 col-md-12">
                                            <p class="no-mb" >
                                                <label for="Property Discount">Property Discount (%) </label>
                                                <input type="number" name="discount" placeholder="Enter Discount Percentage i.e 5">
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-12">
                                            <p class="no-mb">
                                                <label for="date">Date Created (If empty, today is assigned)</label>
                                                <input type="date" name="date" placeholder="Enter Date" >
                                            </p>
                                        </div>
                                        <div class="col-lg-6 col-md-12">
                                            <label for="property_status">Select Property Status <span style="color:red">*</span></label>
                                            <select name="property_status" class="form-control-range" placeholder="Please select a property status" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <p>
                                                ...
                                                <textarea id="description" form="property-form" name="descrip" placeholder="Describe about your property"></textarea>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="single-add-property">
                                ...
                                <div class="property-form-group">
                                    <div class="row">
                                        <div class=" col-md-12">
                                            <p class="">
                                                ...
                                                <input type="text" name="buyer-name" placeholder="Enter Buyer's Name" required>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <p>
                                                ...
                                                <textarea  form="property-form" name="buyer-addr" placeholder="Enter Buyer Address"></textarea>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                         <div class="col-lg-6 col-md-12">
                                            <p class="no-mb ">
                                                ...
                                                <input type="tel" name="buyer-phone" placeholder="Phone Number" required>
                                            </p>
                                        </div>
                                        <div class="col-lg-6 col-md-12">
                                            <p class="no-mb last">
                                                <label for="BC_name">Buyer Company Name (Optional)</label>
                                                <input type="text" name="BC-name" placeholder="Enter Buyer Company Name" >
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                         <div class="col-lg-6 col-md-12">
                                            <p class="no-mb ">
                                                <label for="email">Buyer Email Address (Optional)</label>
                                                <input type="email" name="buyer-email" placeholder="Enter Buyer Email Address">
                                            </p>
                                        </div>
                                        <div class="col-lg-6 col-md-12">
                                            <label for="payment_type">Buyer Payment type <span style="color:red">*</span></label>
                                            <select name="payment-type" class="form-control-range" placeholder="Please select a payment type" required>
                                                <option value="">Select An Option (Rent/Sale)</option>
                        ...
                        <div class="single-add-property">
                            ...
                            <div class="property-form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <p>
                                            <label for="c_name">Enter Company Name <span style="color:red">*</span></label>
                                            <input type="text" name="c_name" placeholder="Enter Your Company Name" required>
                                        </p>
                                    </div>
                                </div>
                                <div class="row">
                                        <div class="col-md-12">
                                            <p>
                                                <label for="CE_address">Email Address <span style="color:red">*</span></label>
                                                <input type="email" name="CE-address" placeholder="Enter Company Email Address" required>
                                            </p>
                                        </div>
                                </div>
                                <div class="row">
                                        <div class="col-md-12">
                                            <p>
                                                <label for="C_address">Company Address (Optional)</label>
                                                <textarea name="C-address" placeholder="Enter Company Address"></textarea>
                                            </p>
                                        </div>
                                </div>
                            </div>
