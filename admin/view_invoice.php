...
<!DOCTYPE html>
<html lang="zxx">
<!-- Mirrored from code-theme.com/html/findhouses/favorited-listings.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Jul 2021 19:47:54 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <title>Elite Expert - View Invoice</title>
    <!-- FAVICON -->
                            ...
                            <table class="table-responsive">
                                ...
                                <?php
                                  ...
                                  echo'  <tr>
                                        ...
                                        <td>'.$date_added.'</td>
                                        <td class="actions">
                                            <a href="invoice.php?inid='.$invoice_id.'" class="edit"><i class="lni-pencil"></i>Print</a>
                                            <a href="../script/delete_invoice.php?inid='.$invoice_id.'"><i class="far fa-trash-alt"></i></a>
                                        </td>
                                    </tr>';
                                }
                            }
